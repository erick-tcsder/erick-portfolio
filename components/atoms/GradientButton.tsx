...
export const GradientButton : React.FC<GradientButtonProps> = (props)=>{
  ...
  return (
    <Button {...buttonProps}
      className={classNames('bg-gradient-to-tl from-blue to-fuscia hover:from-sky-500 hover:to-blue transition-all overflow-hidden p-0.5 md:p-1 rounded-md group',className)}
    >
      <div className='py-1.5 rounded-md overflow-hidden'>
        <span className='bg-light px-3 py-1.5 w-full'>
